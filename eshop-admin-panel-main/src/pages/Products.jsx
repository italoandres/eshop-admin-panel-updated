...
export default function Products() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL || 'https://eshop-backend-bfhw.onrender.com/api'}/products?${params.toString()}`
      );
  ...
  const toggleProductStatus = async (id) => {
    try {
      await axios.patch(`${import.meta.env.VITE_API_URL || 'https://eshop-backend-bfhw.onrender.com/api'}/products/${id}/toggle-status`);
      fetchProducts();
    } catch (error) {
  ...
  const deleteProduct = async (id) => {
    ...
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL || 'https://eshop-backend-bfhw.onrender.com/api'}/products/${id}`);
      fetchProducts();
    } catch (error) {
