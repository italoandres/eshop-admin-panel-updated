...
import 'core/config/flavors/dev_config.dart';
...
Future<void> main() async {
  ...
  // Configurar flavor (ambiente)
  FlavorConfig.setFlavor(Flavor.dev, devConfig);
      ...
      child: OKToast(
        child: Sizer(builder: (context, orientation, deviceType) {
          return MaterialApp(
            ...
            title: FlavorConfig.appName, // Usa nome do flavor
            theme: defaultTheme.lightTheme, // Usa tema configurável
