          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "$orderItems : ${orderDetails!.orderItems.length}",
                  style: const TextStyle(
                    fontSize: 14,
                  ),
                ),
                Text(
                  "$orderPrice : ${orderDetails!.orderItems.fold(0.0, (previousValue, element) => (previousValue + (element.price * element.quantity)))}",
                  style: const TextStyle(
                    fontSize: 14,
                  ),
                ),
